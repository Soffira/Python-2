...
def test_action_get_echo(initial_request, expected_action, expected_code, expected_data):
    actual_response = get_echo(initial_request)
    assert actual_response.get('action') == expected_action

def test_code_get_echo(initial_request, expected_code, expected_data):
    actual_response = get_echo(initial_request)
